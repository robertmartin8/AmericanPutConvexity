...
Since $b$ is continuous at $0$ with $b(0)=0$, convexity extends to
$[0,\infty)$, and by \eqref{eq:expiry} the right derivative at $0$ is
$-\infty$. This singularity never enters the argument:
Lemma~\ref{lem:threepoint} needs only continuity of the boundary, and
\eqref{eq:expiry} is used once, in the chord argument.
...
carried out largely by frontier AI models, with the author selecting the problem, directing the investigation, and making editorial decisions. The
